...
// =========================================================
// /admin/no-access — safe browser states
// =========================================================
// Two distinct states, driven by the client policy mirror:
//
...
//   by AuthProvider; this page offers retry, password recovery, and logout.
//
...
export default function NoAccessPage() {
  ...
  const unavailable = policyStatus === "unavailable";
