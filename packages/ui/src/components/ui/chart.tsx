...
// =========================================================
// shadcn/ui chart wrapper (Recharts v3)
// =========================================================
// Adapted from the shadcn/ui chart component for Recharts 3.x and this
// repo's Tailwind 3 setup (hsl() token colors, `outline-none`, arbitrary
// color properties). Provides ChartContainer (theme + CSS-var injection),
